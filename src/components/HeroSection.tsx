                    ...
                    <div className="relative">
                        ...
                        >
                            ...
                            <button
                                ...
                                className="w-full md:w-auto tech-clip-btn inline-flex cursor-pointer items-center justify-center border border-[#2A2A33] bg-surface-dark/50 backdrop-blur-sm px-8 md:px-10 py-3 md:py-4 text-base md:text-lg font-display font-bold uppercase tracking-widest text-white hover:border-primary hover:text-primary transition-all group"
                            >
